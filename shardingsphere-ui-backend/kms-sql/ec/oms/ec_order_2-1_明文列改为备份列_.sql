...
alter table ec_oms_address_modify_record change receiver_phone receiver_phone_plain varchar(32) comment '收货人固定电话';
alter table ec_oms_invoice change buyer_bank_account buyer_bank_account_plain varchar(128) comment '购买方开户行帐号';
alter table ec_oms_invoice change buyer_phone buyer_phone_plain varchar(32) comment '购买方固话';
...
alter table ec_oms_order change receiver_phone receiver_phone_plain varchar(32) comment '收货人固定电话';
...
alter table ec_oms_plat_tmall_presale_order change receiver_phone receiver_phone_plain varchar(32) comment '收货人固定电话';
...
alter table ec_oms_order_import change receiver_phone receiver_phone_plain varchar(32) comment '收货人固定电话';
...
alter table ec_oms_exc_reissue_order change receiver_phone receiver_phone_plain varchar(32) comment '补发收货人固定电话';
