...
alter table ec_oms_address_modify_record change receiver_phone_cipher receiver_phone varchar(152) comment '收货人固定电话';
...
alter table ec_oms_exc_reissue_order change receiver_phone_cipher receiver_phone varchar(152) comment '补发收货人固定电话';
...
alter table ec_oms_invoice change buyer_phone_cipher buyer_phone varchar(152) comment '购买方固话';
...
alter table ec_oms_order change receiver_phone_cipher receiver_phone varchar(152) comment '收货人固定电话';
...
alter table ec_oms_order_import change receiver_phone_cipher receiver_phone varchar(152) comment '收货人固定电话';
...
alter table ec_oms_plat_tmall_presale_order change receiver_phone_cipher receiver_phone varchar(152) comment '收货人固定电话';
